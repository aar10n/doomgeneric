...
#define DOOM_KEYP_DIVIDE    '/'
#define DOOM_KEYP_PLUS      '+'
#define DOOM_KEYP_MINUS     '-'
#define DOOM_KEYP_MULTIPLY  '*'
#define DOOM_KEYP_PERIOD    0
#define DOOM_KEYP_EQUALS    DOOM_KEY_EQUALS
#define DOOM_KEYP_ENTER     DOOM_KEY_ENTER
